...
import alipay.demo.trade.DemoHbRunner;
import alipay.demo.trade.Main;
...
import com.kp1nz.dao.*;
import com.kp1nz.pojo.*;
import com.kp1nz.pojo.Product;
import com.kp1nz.service.IOrderService;
import com.kp1nz.utils.BigDecimalUtils;
import com.kp1nz.utils.DateUtils;
import com.kp1nz.utils.FTPUtil;
import com.kp1nz.utils.PropertiesUtils;
import com.kp1nz.vo.CartOrderItemVO;
import com.kp1nz.vo.OrderItemVO;
import com.kp1nz.vo.OrderVO;
import com.kp1nz.vo.ShippingVO;
...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse alipay_callback(Map<String, String> map) {
        ...
        if(result>0){
            return ServerResponse.serverResponseBySuccess("支付信息保存成功！");
        }
    ...
    public ServerResponse pay(Order order) throws IOException {
        ...
        AlipayTradePrecreateRequestBuilder builder = new AlipayTradePrecreateRequestBuilder()
                ...
                //"http://39.105.33.241:8080/order/alipay_callback.do"
                .setNotifyUrl("http://nsqrkp.natappfree.cc/order/alipay_callback.do")
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                ///usr/gy/developer/img/"+"/qr-%s.png
//                "/developer/img/"+"qr-%s.png"
                //C:/Workbench/ftpfile/qr-%s.png
                String filePath = String.format("C:/Workbench/ftpfile/qr-%s.png",
