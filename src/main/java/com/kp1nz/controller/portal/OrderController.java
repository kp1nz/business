...
public class OrderController {
     ...
     * 创建订单
     */
    @RequestMapping(value = "creatOrder.do")
...
//            boolean result = AlipaySignature.rsaCheckV2(requestparams, PropertiesUtils.readByKey("public_key"),"utf-8",PropertiesUtils.readByKey("sign_type"));
            if (!result) {
                System.out.println("非法请求，验证不通过");
